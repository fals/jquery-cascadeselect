...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="row">
      <fieldset>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <asp:DropDownList ID="country" runat="server" CssClass="input-xlarge">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <asp:DropDownList ID="city" runat="server" CssClass="input-xlarge">
  ...
  <script>
    $('#<%= country.ClientID %>').cascadeselect({
      source: '<%= ResolveUrl("LocationService.asmx/GetCountries") %>',
      selectText: "Select Something",
      loadingText: 'Loading...',
      noneResultText: 'No items found!'
    });

    $('#<%= state.ClientID %>').cascadeselect({
      source: '<%= ResolveUrl("LocationService.asmx/GetStates") %>',
      selectText: "Select the State",
      loadingText: 'Loading States...',
      noneResultText: 'No States Found!',
      parentSelectId: '<%= country.ClientID %>',
      paramName: 'countyId'
    });

    $('#<%= city.ClientID %>').cascadeselect({
      source: '<%= ResolveUrl("LocationService.asmx/GetCities") %>',
      selectText: "Select the City",
      loadingText: 'Loading Cities...',
      noneResultText: 'No Cities Found!',
      parentSelectId: '<%= state.ClientID %>',
      paramName: 'stateId'
    });
  </script>
