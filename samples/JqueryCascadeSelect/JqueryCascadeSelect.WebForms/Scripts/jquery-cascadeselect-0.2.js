...
/
/ Jquery extesion to allow developers to easily create cascade 
/ dependents html selects, that can be populated via restful services.
/ 
/ FALS - 2014
/ site: https://github.com/fals/jquery-cascadeselect
/
*/
    ...
    var _getSelectOptions = function (select, value) {
      ...
      $.ajax({
        ...
        success: function (data) {
          var result = data.hasOwnProperty("d") ? JSON.parse(data.d) : data;
          if (result.length > 0) {
